...
class Helpsupport:
    def __init__(self, root):
        ...
        std_img_btn = Image.open(
            r"C:\Users\ajays\PycharmProjects\facial recognition attendance system\Images_GUI\web.png")
        ...
        det_img_btn = Image.open(
            r"C:\Users\ajays\PycharmProjects\facial recognition attendance system\Images_GUI\fb.png")
        ...
        det_b1_1 = Button(bg_img, command=self.facebook, text="Facebook", cursor="hand2", font=("tahoma", 15, "bold"),
                          bg="white", fg="navyblue")
        det_b1_1.place(x=480, y=380, width=180, height=45)

        # Attendance System  button 3
        att_img_btn = Image.open(
            r"C:\Users\ajays\PycharmProjects\facial recognition attendance system\Images_GUI\yt.png")
        ...
        att_b1_1 = Button(bg_img, command=self.youtube, text="Youtube", cursor="hand2", font=("tahoma", 15, "bold"),
                          bg="white", fg="navyblue")
        att_b1_1.place(x=710, y=380, width=180, height=45)

        # Help  Support  button 4
        hlp_img_btn = Image.open(
            r"C:\Users\ajays\PycharmProjects\facial recognition attendance system\Images_GUI\gmail.png")
