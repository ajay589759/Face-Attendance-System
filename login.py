...
class Login:
    ...
    def __init__(self, root):
        ...
        self.bg = ImageTk.PhotoImage(
            file=r"C:\Users\ajays\PycharmProjects\facial recognition attendance system\Images_GUI\loginBg1.jpg")
        ...
        img1 = Image.open(r"C:\Users\ajays\PycharmProjects\facial recognition attendance system\Images_GUI\log1.png")
        ...
        loginbtn = Button(frame1, command=self.reg, text="Register", font=("times new roman", 10, "bold"), bd=0,
        ...
        loginbtn = Button(frame1, command=self.forget_pwd, text="Forget", font=("times new roman", 10, "bold"), bd=0,
                          relief=RIDGE, fg="white", bg="#002B53", activeforeground="orange", activebackground="#002B53")
...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        hlp_b1_1 = Button(bg_img, text="Help Support", cursor="hand2", font=("tahoma", 15, "bold"), bg="white",
                          fg="navyblue")
        ...
        dev_img_btn = Image.open(
            r"C:\Users\ajays\PycharmProjects\facial recognition attendance system\Images_GUI\dev.jpg")
