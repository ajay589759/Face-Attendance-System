...
# Testing Connection
"""
conn = mysql.connector.connect(username='root', password='root123',host='localhost',database='face_recognition',port=3306)
cursor = conn.cursor()
...
class Student:
    def __init__(self, root):
        ...
        # title section
        title_lb1 = Label(bg_img, text="Welcome to Student Pannel", font=("verdana", 30, "bold"), bg="white",
                          fg="navyblue")
        ...
        # Date of Birth
        student_dob_label = Label(class_Student_frame, text="DOB:", font=("verdana", 12, "bold"), fg="navyblue",
                                  bg="white")
