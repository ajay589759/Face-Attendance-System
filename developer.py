...
# This part is image labels setting start 
        ...
        # backgorund image
        bg1=Image.open(r"C:\Users\ajays\PycharmProjects\facial recognition attendance system\Images_GUI\bg4.png")
        ...
        # -------------------------------------------------------------------------------------------------------------------
        # student button 1
        std_img_btn=Image.open(r"C:\Users\ajays\PycharmProjects\facial recognition attendance system\Images_GUI\Ajay (2).jpg")
        ...
        std_b1_1 = Button(bg_img,text="Ajay",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        std_b1_1.place(x=250,y=380,width=180,height=45)

        # Detect Face  button 2
        det_img_btn = Image.open(r"C:\Users\ajays\PycharmProjects\facial recognition attendance system\Images_GUI\Rutu.jpg")
        ...
        det_b1_1 = Button(bg_img, text="Ruturaj", cursor="hand2", font=("tahoma", 15, "bold"), bg="white",
                          fg="navyblue")
        det_b1_1.place(x=480, y=380, width=180, height=45)

        # Attendance System  button 3
        att_img_btn = Image.open(r"C:\Users\ajays\PycharmProjects\facial recognition attendance system\Images_GUI\krish.jpg")
        ...
        att_b1_1 = Button(bg_img, text="Krish", cursor="hand2", font=("tahoma", 15, "bold"), bg="white",
                          fg="navyblue")
